...
\subtext{Link: \url{https://gsn.yktaero.space} \hfill Stack: Python, Django, Jinja2, Django REST}
\begin{zitemize}
...
\subtext{Link: \url{https://docs.yktaero.space} \hfill Stack: Python, Django, Jinja2, Django REST}
\begin{zitemize}
