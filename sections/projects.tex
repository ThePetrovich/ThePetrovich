...
\subtext{Link: \url{http://tawhiri.stratoflights.yktaero.space} \hfill Stack: Python, Flask, Jquery}
\begin{zitemize}
...
\subtext{Personal project, link: \url{https://jfkerman.me} \hfill Stack: VMware ESXi, pfSense, nginx, Django}
\begin{zitemize}
